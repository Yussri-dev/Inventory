...
namespace Inventory.Domain.Entities
{
    public class CashSession : TenantEntity
    {
        ...
        /*
         * Stable id generated by the POS/outbox and reused for every
         * retry. TenantId + ClientOperationId must be unique.
         */
        [Required]
        ...
        public ICollection<CashReport> CashReports { get; set; } =
            new List<CashReport>();
    }
}
