...
using Inventory.Services.Features.CashReport.GetById;
...
namespace Inventory.Api.Controllers
{
    ...
    public class CashReportsController : ControllerBase
    {
        ...
        public CashReportsController(IMediator mediator)
        {
            _mediator = mediator;
        }
        [HttpPost]
        ...
        public async Task<IActionResult> Create(
            [FromBody] CreateCashReportRequest request,
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await _mediator.Send(
                new CreateCashReportCommand(request),
                cancellationToken
            );
        ...
        public async Task<IActionResult> Update(
            Guid id,
            [FromBody] UpdateCashReportRequest request,
            CancellationToken cancellationToken)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            var result = await _mediator.Send(
                new UpdateCashReportCommand(id, request),
                cancellationToken
            );
            return Ok(result);
        }
        ...
        public async Task<IActionResult> Delete(Guid id, CancellationToken cancellationToken)
        {
            await _mediator.Send(
                new DeleteCashReportCommand(id),
                cancellationToken
            );
            return NoContent();
        }
        ...
        public async Task<IActionResult> Search(
            [FromQuery] CashReportQuery query,

            CancellationToken cancellationToken)
        {
            var result = await _mediator.Send(
                new SearchCashReportsQuery(query),
                cancellationToken
            );
            return Ok(result);
        }
