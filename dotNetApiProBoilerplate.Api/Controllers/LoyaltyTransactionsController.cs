...
using Inventory.Services.Features.LoyaltyTransactions.Update;
using MediatR;
...
namespace Inventory.Api.Controllers
{
    [ApiController]
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/loyaltyTransactions")]

    //[Authorize]
    public class LoyaltyTransactionsController : ControllerBase
    {
        private readonly IMediator _mediator;
        public LoyaltyTransactionsController(IMediator mediator)
        {
            _mediator = mediator;
        }
        [HttpPost]
        ...
        public async Task<IActionResult> Create(
            [FromBody] CreateLoyaltyTransactionRequest request,
            ...
            CancellationToken cancellationToken)
        {
            ...
            var result = await _mediator.Send(
                new CreateLoyaltyTransactionCommand(request),
                cancellationToken
            );
        ...
        {
            var result = await _mediator.Send(
                new GetLoyaltyTransactionByIdQuery(id),
                cancellationToken
            );
            return Ok(result);
        }
        ...
        public async Task<IActionResult> GetAll(CancellationToken cancellationToken)
        {
            var results = await _mediator.Send(
                new GetAllLoyaltyTransactionsQuery(),
                cancellationToken
            );
            return Ok(results);
        }
        ...
        public async Task<IActionResult> Update(
            Guid id,
            [FromBody] UpdateLoyaltyTransactionRequest request,
            CancellationToken cancellationToken)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            var result = await _mediator.Send(
                new UpdateLoyaltyTransactionCommand(id, request),
                cancellationToken
            );
            return Ok(result);
        }
        ...
        public async Task<IActionResult> Delete(Guid id, CancellationToken cancellationToken)
        {
            await _mediator.Send(
                new DeleteLoyaltyTransactionCommand(id),
                cancellationToken
            );
            return NoContent();
        }
        ...
        public async Task<IActionResult> Search(
            [FromQuery] LoyaltyTransactionQuery query,

            CancellationToken cancellationToken)
        {
            var result = await _mediator.Send(
                new SearchLoyaltyTransactionsQuery(query),
                cancellationToken
            );
            return Ok(result);
        }
